...
# Check availability of data for the past 10 years
print("Income Statement:")
print(financials.head(10))  # Display data for review

print("\nBalance Sheet:")
print(balance_sheet.head(10))  # Display data for review

print("\nCash Flow Statement:")
print(cash_flow.head(10))  # Display data for review

# Define the output Excel file
output_file = "company_financial_reports_10_years.xlsx"
